...
const items = () => {
  ...
  // Only the owner sees Instructor Management.
...
async function dashboard() {
  ...
  if (state.user.instructorRole === 'owner') {
    try {
      ...
      state.instructors = result.instructors;

      pendingCount = state.instructors.filter(
        x => x.status === 'pending'
      ).length;
    } catch {
      pendingCount = 0;
...
async function instructors() {
  ...
  const pending = state.instructors.filter(
    x => x.status === 'pending'
  );

  const approved = state.instructors.filter(
    x => x.status === 'approved'
  );

  const rejected = state.instructors.filter(
    x => x.status === 'rejected'
  );
    ...
    <div class="page">
      ...
      <div class="page-head">
        <div>
          ...
          <p>
            Review instructor signup requests and
            control access to the AI360 workspace.
          </p>
        </div>
      </div>
      ...
      <div class="chat-main">
        ...
        <div class="composer-area">
          ...
          <small>
            ...
            information and keep personal details
            private.
          </small>
    ...
    <div class="page">
      ...
      <div class="page-head">
        ...
        <div>
          ...
          <p>
            Create a private code for each
            student and assign a group.
          </p>
        </div>
    ...
    <div class="page">
      ...
      <div class="page-head">
        ...
        <div>
          ...
          <p>
            Present a shared question or
            activity on a projector.
          </p>
        </div>
    ...
    <div class="page">
      ...
      <div class="panel">
        ...
        <p>
          ...
          only their own conversations; approved
          instructors can review student activity.
        </p>
